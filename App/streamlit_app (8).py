...
# CONFIGURATION
# ═══════════════════════════════════════════════
BRANDING = "Entertainment AI Hub \u2022 Crafted by Dev Manghani \u2022 Microsoft Elevate 2026"
...
<style>
    ...
    div.block-container { padding-top: 2rem; max-width: 1280px; }

    h1 {
        font-family: 'Space Grotesk', sans-serif !important;
        font-weight: 700 !important; font-size: 2.4rem !important;
        color: #ffffff !important; text-align: center;
        letter-spacing: -1px; margin-bottom: 6px !important;
    }
    h2 { font-family: 'Space Grotesk', sans-serif !important; color: #f0f0f0 !important; font-weight: 600 !important; font-size: 1.4rem !important; }
    h3 { font-family: 'Space Grotesk', sans-serif !important; color: #d0d0d0 !important; font-weight: 600 !important; }

    .subtitle-wrapper { text-align: center; margin: -4px 0 40px 0; }
    .subtitle-typewriter { font-family: 'Inter', sans-serif; font-size: 0.95rem; color: #666666; font-weight: 400; }
    .section-desc { font-family: 'Inter', sans-serif; font-size: 0.9rem; color: #777777; margin-bottom: 22px; line-height: 1.65; }
    ...
    .hero-tagline { font-family: 'Inter', sans-serif; font-size: 0.95rem; color: #777777; max-width: 600px; margin: 0 auto 28px; line-height: 1.75; }
    .hero-tagline strong { color: #bbbbbb; font-weight: 600; }
    .hero-stats { display: flex; justify-content: center; gap: 48px; flex-wrap: wrap; }
    .hero-stat { text-align: center; }
    .hero-stat-value { font-family: 'Space Grotesk', sans-serif; font-weight: 700; font-size: 1.8rem; color: #ffffff; }
    .hero-stat-label { font-family: 'Inter', sans-serif; font-size: 0.7rem; color: #555555; text-transform: uppercase; letter-spacing: 1.4px; margin-top: 4px; }

    .stTabs [data-baseweb="tab-list"] { background: #0f0f0f; border-radius: 10px; padding: 5px; border: 1px solid #1e1e1e; gap: 4px; }
    .stTabs [data-baseweb="tab"] { border-radius: 7px; padding: 10px 22px; color: #888888 !important; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 0.97rem; transition: all 0.2s ease; }
    .stTabs [aria-selected="true"] { background: #1a1a1a !important; color: #ffffff !important; border-bottom: 2px solid #ffffff !important; }
    .stTabs [data-baseweb="tab"]:hover { color: #cccccc !important; }
    .stTabs [data-baseweb="tab-list"] button [data-testid="stMarkdownContainer"] p { font-size: 0.97rem; font-weight: 700; }

    .metric-card { background: #0f0f0f; border: 1px solid #1a1a1a; border-radius: 10px; padding: 22px 16px; text-align: center; transition: border-color 0.2s ease; }
    .metric-card:hover { border-color: #2a2a2a; }
    .metric-label { font-family: 'Inter', sans-serif; font-size: 0.7rem; color: #555555; text-transform: uppercase; letter-spacing: 1.2px; font-weight: 500; margin-bottom: 6px; }
    .metric-value { font-family: 'Space Grotesk', sans-serif; font-size: 1.8rem; font-weight: 700; color: #ffffff; }

    .cinema-card { background: #0f0f0f; border: 1px solid #1a1a1a; border-radius: 8px; padding: 14px 16px; margin-bottom: 8px; transition: border-color 0.2s ease; display: flex; align-items: center; gap: 14px; }
    .cinema-card:hover { border-color: #333333; }
    .cinema-rank { font-family: 'Space Grotesk', sans-serif; font-weight: 700; font-size: 1.1rem; color: #444444; min-width: 28px; }
    .cinema-title { font-family: 'Inter', sans-serif; font-weight: 600; font-size: 0.92rem; color: #dddddd; }
    .genre-pill { background: #161616; color: #777777; padding: 3px 9px; border-radius: 4px; font-size: 0.73rem; border: 1px solid #222222; font-family: 'Inter', sans-serif; }

    .result-panel { background: #0f0f0f; border: 1px solid #1e1e1e; border-radius: 12px; padding: 32px 24px; text-align: center; margin-top: 18px; }

    .model-card { background: #0f0f0f; border: 1px solid #1a1a1a; border-radius: 10px; padding: 22px; transition: border-color 0.2s ease; position: relative; overflow: hidden; }
    .model-card:hover { border-color: #2a2a2a; }
    .model-card-title { font-family: 'Space Grotesk', sans-serif; font-weight: 700; font-size: 0.95rem; color: #eeeeee; margin-bottom: 4px; }
    .model-card-sub { font-family: 'Inter', sans-serif; font-size: 0.78rem; color: #555555; margin-bottom: 14px; line-height: 1.5; }
    .model-metric-row { display: flex; justify-content: space-between; align-items: center; padding: 8px 0; border-bottom: 1px solid #161616; }
    .model-metric-row:last-child { border-bottom: none; }
    .model-metric-name { font-family: 'Inter', sans-serif; font-size: 0.8rem; color: #555555; }
    .model-metric-value { font-family: 'Space Grotesk', sans-serif; font-weight: 600; font-size: 0.9rem; color: #bbbbbb; }

    .stButton > button {
        background: #ffffff !important; color: #0a0a0a !important;
        border: none !important; border-radius: 7px !important;
        padding: 11px 26px !important; font-family: 'Inter', sans-serif !important;
    ...
    .stDownloadButton > button {
        background: #111111 !important; color: #aaaaaa !important;
        border: 1px solid #2a2a2a !important; border-radius: 7px !important;
        font-family: 'Inter', sans-serif !important; font-weight: 500 !important;
        transition: all 0.2s ease !important;
    }
    .stDownloadButton > button:hover { border-color: #666666 !important; color: #ffffff !important; }

    .stLinkButton > a {
        background: #0f0f0f !important; border: 1px solid #222222 !important;
        border-radius: 7px !important; color: #777777 !important;
        font-family: 'Inter', sans-serif !important; font-weight: 500 !important;
        font-size: 0.87rem !important; transition: all 0.2s ease !important; text-decoration: none !important;
    }
    .stLinkButton > a:hover { border-color: #444444 !important; color: #ffffff !important; }

    .stTextArea textarea { background: #0f0f0f !important; border: 1px solid #222222 !important; border-radius: 7px !important; color: #e8e8e8 !important; font-family: 'Inter', sans-serif !important; font-size: 0.9rem !important; caret-color: #ffffff !important; }
    .stTextArea textarea:focus { border-color: #444444 !important; box-shadow: none !important; }
    .stTextArea textarea::placeholder { color: #333333 !important; }

    .stSelectbox > div > div { background: #0f0f0f !important; border: 1px solid #222222 !important; border-radius: 7px !important; color: #e8e8e8 !important; }
    .stSelectbox [data-baseweb="select"] span, .stSelectbox [data-baseweb="select"] input { color: #e8e8e8 !important; -webkit-text-fill-color: #e8e8e8 !important; }

    .stMultiSelect > div > div { background: #0f0f0f !important; border: 1px solid #222222 !important; border-radius: 7px !important; }
    .stMultiSelect [data-baseweb="tag"] { background: #1a1a1a !important; border: 1px solid #2a2a2a !important; color: #aaaaaa !important; border-radius: 4px !important; }

    .stNumberInput > div > div { border: 1px solid #222222 !important; border-radius: 7px !important; background: #0f0f0f !important; }
    .stNumberInput input { background: #0f0f0f !important; color: #e8e8e8 !important; font-family: 'Inter', sans-serif !important; }
    .stNumberInput button { background: #161616 !important; color: #666666 !important; border: none !important; border-left: 1px solid #222222 !important; }
    .stNumberInput button:hover { background: #1e1e1e !important; color: #ffffff !important; }

    [data-baseweb="menu"] [role="option"] { color: #e8e8e8 !important; background: #111111 !important; }
    [data-baseweb="menu"] [role="option"]:hover { background: #1a1a1a !important; color: #ffffff !important; }
    [data-baseweb="menu"], [data-baseweb="popover"] > div { background: #111111 !important; border: 1px solid #222222 !important; border-radius: 8px !important; box-shadow: 0 8px 32px rgba(0,0,0,0.7) !important; }

    .stSelectbox label, .stTextArea label, .stMultiSelect label, .stNumberInput label, .stSlider label { color: #777777 !important; font-family: 'Inter', sans-serif !important; font-weight: 500 !important; font-size: 0.84rem !important; }

    hr { border: none; height: 1px; background: #1a1a1a; margin: 22px 0; }

    .context-badge { display: inline-block; padding: 6px 16px; border-radius: 5px; font-family: 'Inter', sans-serif; font-weight: 600; font-size: 0.82rem; margin-top: 12px; }
    .context-badge.fire     { background: #1a0f0f; color: #ee8888; border: 1px solid #2a1a1a; }
    .context-badge.warm     { background: #1a1500; color: #ddbb55; border: 1px solid #2a2000; }
    .context-badge.moderate { background: #0f1a0f; color: #88bb88; border: 1px solid #1a2a1a; }
    .context-badge.cool     { background: #0f1520; color: #7799bb; border: 1px solid #1a2535; }

    .conf-bar-track { width: 100%; height: 5px; background: #1a1a1a; border-radius: 5px; overflow: hidden; margin-top: 12px; }
    .conf-bar-fill { height: 100%; border-radius: 5px; background: #dddddd; transition: width 0.8s ease; }
    ...
    section[data-testid="stSidebar"] { background: #080808 !important; border-right: 1px solid #161616; }

    .pro-footer { text-align: center; padding: 24px 20px 12px; margin-top: 36px; border-top: 1px solid #161616; }
    .footer-brand { font-family: 'Space Grotesk', sans-serif; font-weight: 700; font-size: 0.95rem; color: #ffffff; margin-bottom: 6px; }
    .footer-copy { font-family: 'Inter', sans-serif; font-size: 0.68rem; color: #3a3a3a; margin-top: 6px; letter-spacing: 0.4px; }
    ...
    [data-stale="true"] { opacity: 0.65 !important; }
...
with st.sidebar:
    st.markdown("""
    <div style='padding: 18px 8px 14px 8px; border-bottom: 1px solid #161616; margin-bottom: 6px;'>
        <p style='font-family: Space Grotesk, sans-serif; font-weight: 700;
            color: #ffffff; font-size: 1.05rem; margin: 0 0 2px 0; letter-spacing: -0.3px;'>
            Entertainment AI Hub
        </p>
        <p style='color: #444444; font-size: 0.76rem; font-family: Inter, sans-serif; margin: 0;'>
    ...
    st.markdown("---")
    st.markdown("<p style='color:#444444; font-size:0.7rem; text-transform:uppercase; letter-spacing:1.2px; font-family:Inter,sans-serif; font-weight:600; margin-bottom:8px;'>About</p>", unsafe_allow_html=True)
    st.markdown("""
    <p style='color:#555555; font-size:0.82rem; line-height:1.65; font-family:Inter,sans-serif;'>
    Combines <strong style='color:#999999;'>Machine Learning</strong>,
    <strong style='color:#999999;'>NLP</strong>, and
    <strong style='color:#999999;'>Data Analytics</strong> to surface insights
    from large-scale entertainment datasets.
    </p>
    """, unsafe_allow_html=True)

    st.markdown("---")
    st.markdown("<p style='color:#444444; font-size:0.7rem; text-transform:uppercase; letter-spacing:1.2px; font-family:Inter,sans-serif; font-weight:600; margin-bottom:8px;'>Tech Stack</p>", unsafe_allow_html=True)
    st.markdown("""
    <p style='color:#8888aa; font-size:0.82rem; line-height:1.8;'>
    Frontend: Streamlit<br>
    ML Engine: scikit-learn<br>
    NLP: NLTK + TF-IDF<br>
    Data: TMDB 5000, MovieLens<br>
    ...
    st.markdown("---")
    st.markdown("""
    <div style='padding: 12px 10px; background: #0f0f0f; border-radius: 7px;
        border: 1px solid #1a1a1a; text-align:center;'>
        <p style='color:#aaaaaa; font-family:Inter,sans-serif;
           font-weight:600; font-size:0.82rem; margin:0 0 2px 0;'>
           Dev Manghani
        </p>
        <p style='color:#444444; font-family:Inter,sans-serif;
           font-weight:400; font-size:0.7rem; margin:0; letter-spacing:0.8px; text-transform:uppercase;'>
...
# MAIN TITLE
# ═══════════════════════════════════════════════
st.title("Entertainment AI Hub")
st.markdown("<div class='subtitle-wrapper'><span class='subtitle-typewriter'>Market Insights &nbsp;&nbsp;&mdash;&nbsp;&nbsp; Smart Recommendations &nbsp;&nbsp;&mdash;&nbsp;&nbsp; Predictive Analytics</span></div>", unsafe_allow_html=True)
...
<div class='hero-container fade-in'>
    ...
    <div class='hero-stats'>
        <div class='hero-stat'>
            <div class='hero-stat-value'>{hero_movies}</div>
        ...
        <div class='hero-stat'>
            <div class='hero-stat-value'>{hero_models}</div>
            <div class='hero-stat-label'>ML Models</div>
        </div>
        <div class='hero-stat'>
            <div class='hero-stat-value'>{hero_accuracy}</div>
...
with tab_eda:
    ...
    if movies_df is not None and ratings_df is not None:
        ...
        col1.markdown(f"<div class='metric-card'><div class='metric-label'>Total Movies</div><div class='metric-value'>{len(movies_df):,}</div></div>", unsafe_allow_html=True)
        col2.markdown(f"<div class='metric-card'><div class='metric-label'>Total Ratings</div><div class='metric-value'>{len(ratings_df):,}</div></div>", unsafe_allow_html=True)
        ...
        col4.markdown(f"<div class='metric-card'><div class='metric-label'>Avg Rating</div><div class='metric-value'>{avg_rating}</div></div>", unsafe_allow_html=True)
    ...
    if rec_model is not None:
        ...
        if st.button("Get Recommendations", type="primary", key="rec_btn"):
            with st.spinner("\U0001F50D Analyzing semantic fingerprints — please wait..."):
                ...
                st.toast(f"Found 8 matches for \"{selected_movie}\"")
        ...
        if st.session_state.rec_results is not None:
            ...
            st.markdown(f"<p style='color:#aaaaaa; font-weight:500; font-size:0.88rem; margin-top:12px;'>Showing 8 matches for <em>\"{source}\"</em></p>", unsafe_allow_html=True)
...
with tab_sent:
            ...
            if user_review.strip():
                with st.spinner("Analyzing sentiment..."):
                    ...
                    if pred == 1:
                        ...
                        st.toast("Positive sentiment detected")
                    else:
                        st.session_state.sent_result = {
                            "label": "Negative", "confidence": prob[0] * 100,
                            "emoji": "", "review": user_review
                        }
                        st.toast("Negative sentiment detected")
            else:
    ...
    if st.session_state.sent_result is not None:
        ...
        label_text = "Positive Sentiment" if r["label"] == "Positive" else "Negative Sentiment"
        ...
        try:
            ...
            if len(active_indices) > 0:
                ...
                if pos_words or neg_words:
                    ...
                    with wc1:
                        if pos_words:
                            st.markdown("<p style='color:#aaaaaa; font-weight:600; font-size:0.85rem;'>Positive Signals</p>", unsafe_allow_html=True)
                    ...
                    with wc2:
                        if neg_words:
                            st.markdown("<p style='color:#aaaaaa; font-weight:600; font-size:0.85rem;'>Negative Signals</p>", unsafe_allow_html=True)
...
with tab_pop:
    ...
    if pop_model is not None:
        ...
        if st.button("Predict Popularity", type="primary", key="pop_btn"):
            if selected_genres:
                with st.spinner("Calculating popularity score..."):
                ...
                # Context badge logic
                if pred_pop > 100:
                    badge_class, badge_text, badge_emoji = "fire", "Blockbuster Potential", ""
                    score_color = "#f5576c"
                elif pred_pop > 50:
                    badge_class, badge_text, badge_emoji = "warm", "Strong Market Presence", ""
                    score_color = "#fda085"
                elif pred_pop > 20:
                    badge_class, badge_text, badge_emoji = "moderate", "Moderate Interest", ""
                    score_color = "#667eea"
                else:
                    badge_class, badge_text, badge_emoji = "cool", "Niche Audience", ""
                    score_color = "#64c8ff"
...
with tab_model:
    ...
    with col_m1:
        ...
        <div class='model-card fade-in'>
            <div style='font-size:0.7rem; color:#444444; text-transform:uppercase; letter-spacing:1.2px; font-family:Inter,sans-serif; font-weight:600; margin-bottom:10px;'>Content Recommender</div>
            <div class='model-card-title'>Cosine Similarity</div>
            <div class='model-card-sub'>Genre-encoded feature vectors with cosine similarity scoring</div>
            ...
            <div class='model-metric-row'>
                ...
                <span class='model-metric-value'>Cosine Sim</span>
            </div>
            <div class='model-metric-row'>
                <span class='model-metric-name'>Movies Indexed</span>
                <span class='model-metric-value'>{rec_movies_count:,}</span>
            </div>
            <div class='model-metric-row'>
                <span class='model-metric-name'>Feature Dims</span>
                <span class='model-metric-value'>{rec_features}</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_m2:
        ...
        st.markdown(f"""
        <div class='model-card fade-in'>
            <div style='font-size:0.7rem; color:#444444; text-transform:uppercase; letter-spacing:1.2px; font-family:Inter,sans-serif; font-weight:600; margin-bottom:10px;'>Sentiment Analyzer</div>
            <div class='model-card-title'>Logistic Regression</div>
            <div class='model-card-sub'>TF-IDF vectorization with Logistic Regression classifier</div>
            <div class='model-metric-row'>
                <span class='model-metric-name'>Status</span>
            ...
            <div class='model-metric-row'>
                <span class='model-metric-name'>Algorithm</span>
                <span class='model-metric-value'>{sent_algo}</span>
            </div>
            <div class='model-metric-row'>
                <span class='model-metric-name'>Vectorizer</span>
                <span class='model-metric-value'>{sent_vectorizer}</span>
            </div>
            <div class='model-metric-row'>
                <span class='model-metric-name'>Vocabulary</span>
                <span class='model-metric-value'>{vocab_size:,}</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_m3:
        ...
        st.markdown(f"""
        <div class='model-card fade-in'>
            <div style='font-size:0.7rem; color:#444444; text-transform:uppercase; letter-spacing:1.2px; font-family:Inter,sans-serif; font-weight:600; margin-bottom:10px;'>Popularity Predictor</div>
            <div class='model-card-title'>Random Forest</div>
            <div class='model-card-sub'>Random Forest Regressor trained on TMDB movie features</div>
            <div class='model-metric-row'>
                <span class='model-metric-name'>Status</span>
            ...
            <div class='model-metric-row'>
                <span class='model-metric-name'>Algorithm</span>
                <span class='model-metric-value'>Random Forest</span>
            </div>
            <div class='model-metric-row'>
                <span class='model-metric-name'>Features</span>
                <span class='model-metric-value'>{pop_features_count}</span>
            </div>
            <div class='model-metric-row'>
                <span class='model-metric-name'>R\u00b2 Score</span>
                <span class='model-metric-value'>{r2_display}</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class='model-card'>
        <div style='display:flex; flex-wrap:wrap; gap:20px; justify-content:center; text-align:center;'>
            <div style='flex:1; min-width:180px; padding:15px;'>
                <div style="margin-bottom:8px; color:#888; font-size:0.8rem; text-transform:uppercase; letter-spacing:1px;">Data Layer</div>
            ...
            <div style='flex:1; min-width:180px; padding:15px;'>
                <div style="margin-bottom:8px; color:#888; font-size:0.8rem; text-transform:uppercase; letter-spacing:1px;">ML Engine</div>
...
with doc_cols[1]:
    st.link_button("\U0001F4BB GitHub", "https://github.com/Devvvv15", use_container_width=True)
with doc_cols[2]:
    st.link_button("\U0001F310 LinkedIn", "https://www.linkedin.com/in/dev-manghani-0a8445276", use_container_width=True)
...
<div class='pro-footer'>
    <div class='footer-brand'>Entertainment AI Hub</div>
