...
<style>
    ...
    .stTabs [data-baseweb="tab"] { border-radius: 7px; padding: 10px 22px; color: #555555 !important; font-family: 'Inter', sans-serif; font-weight: 500; font-size: 0.88rem; transition: all 0.2s ease; }
    ...
    .stTabs [data-baseweb="tab-list"] button [data-testid="stMarkdownContainer"] p { font-size: 0.88rem; font-weight: 500; }
